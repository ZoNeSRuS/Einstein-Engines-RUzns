economybanksystem-transaction-success = Счёт на {$amount} {$currencyName} оплачен
economybanksystem-transaction-error-notenoughmoney = Недостаточно средств
...
economybanksystem-transaction-error-account-blocked = Счёт {$accountId} заблокирован
